...
```groovy
id 'cn.therouter' version '1.2.0-rc1' apply false
```
...
```groovy
classpath "cn.therouter:plugin:1.2.0-rc1"
```
...
```groovy
annotationProcessor "cn.therouter:apt:1.2.0-rc1"
```
...
*从1.2.0开始，beta版本已经全部合入rc版本，无需再特殊关注beta版本进度。*    
